...
export default function AboutPage() {
  return (
    <div style={{ maxWidth: 700, margin: '48px auto', padding: 24 }}>
      ...
      <p style={{ fontSize: 17 }}>
        OSM Map Viewer is a modern web application for exploring OpenStreetMap (OSM) data interactively. It features:
      </p>
      ...
      <p style={{ marginTop: 32, color: '#888' }}>
        Map data &copy; <a href="https://www.openstreetmap.org/copyright" target="_blank" rel="noopener noreferrer">OpenStreetMap contributors</a>.<br />
        Source code available on <a href="https://github.com/your-repo" target="_blank" rel="noopener noreferrer">GitHub</a>.
      </p>
    </div>
  );
}
